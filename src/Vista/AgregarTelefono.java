...
public class AgregarTelefono extends javax.swing.JFrame {
    ...
    public AgregarTelefono(ModificarCliente modCli, int id) {
        initComponents();
        AgregarTelefono.modCli = modCli;
        AgregarTelefono.id = id;
    }
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(txtNum, javax.swing.GroupLayout.PREFERRED_SIZE, 181, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AgregarTelefono(modCli, id).setVisible(true);
            }
        });
    }
